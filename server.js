	...
	db=database;
  	if (err) {
    	console.log('Unable to connect to the mongoDB server. Error:', err);
   		...
   		console.log('MongoDB Connection established', init.mongoConnUrl);
...
console.log('Dashboard started on port ' + init.port + ', ' + init.localhostURL + ':' + init.port + init.backendDirectoryPath);
